...
public class BotCommandStrategyHelp implements BotCommandStrategy {
    ...
    private String help() {
        return "🧾 Список доступных команд:\n" +
                ...
                "В данный момент функция не работает, в связи с тем, что сайт cataas.com упал\uD83D\uDD27 как только он снова заработает функция будет включена!\n" +
                ...
                "В настоящее время ограничение на размер загружаемого документа - 20мб";
    }
}

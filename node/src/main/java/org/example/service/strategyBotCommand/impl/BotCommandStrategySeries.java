...
@Service
public class BotCommandStrategySeries implements BotCommandStrategy {
    private final FilmService filmService;
    private final SendMessageUtil sendMessageUtil;
    @Override
    public void sendAnswer(ApplicationUser applicationUser, long chatId) {
        sendMessageUtil.sendAnswerForFormatLinkFilmAddKeyBoard(filmService.getLinkForSeries(),chatId);
    }

    @Override
    public BotCommands myCommands() {
        return BotCommands.SERIES;
    }
}
